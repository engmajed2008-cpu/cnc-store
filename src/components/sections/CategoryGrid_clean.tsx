    ...
    svgPattern: `
      <defs>
        <pattern id="cg-{id}" width="45" height="45" patternUnits="userSpaceOnUse">
          <path d="M0 0h45v45H0z" fill="none" stroke="#C9A24B" stroke-width=".3" opacity=".3"/>
          <circle cx="0" cy="0" r="1.2" fill="#C9A24B" opacity=".45"/>
          <circle cx="45" cy="0" r="1.2" fill="#C9A24B" opacity=".45"/>
          <circle cx="0" cy="45" r="1.2" fill="#C9A24B" opacity=".45"/>
          <circle cx="45" cy="45" r="1.2" fill="#C9A24B" opacity=".45"/>
        </pattern>
      </defs>
      <rect width="100%" height="100%" fill="url(#cg-{id})"/>
      <circle cx="50%" cy="48%" r="28%" fill="none" stroke="#C9A24B" stroke-width="1.2" stroke-dasharray="7 4" opacity=".4"/>
      <circle cx="50%" cy="48%" r="20%" fill="none" stroke="#EBCB7C" stroke-width=".8" opacity=".35"/>
      <circle cx="50%" cy="48%" r="7%" fill="#0d1208" stroke="#C9A24B" stroke-width="1.5" opacity=".85"/>
      <circle cx="50%" cy="48%" r="2.5%" fill="#C9A24B" opacity=".9"/>
      <line x1="22%" y1="48%" x2="43%" y2="48%" stroke="#C9A24B" stroke-width=".8" opacity=".45"/>
      <line x1="57%" y1="48%" x2="78%" y2="48%" stroke="#C9A24B" stroke-width=".8" opacity=".45"/>
      <line x1="50%" y1="20%" x2="50%" y2="41%" stroke="#C9A24B" stroke-width=".8" opacity=".45"/>
      <line x1="50%" y1="55%" x2="50%" y2="76%" stroke="#C9A24B" stroke-width=".8" opacity=".45"/>
      <line x1="50%" y1="20%" x2="50%" y2="15%" stroke="#C9A24B" stroke-width="1.2" opacity=".5"/>
      <line x1="78%" y1="48%" x2="83%" y2="48%" stroke="#C9A24B" stroke-width="1.2" opacity=".5"/>
      <line x1="50%" y1="76%" x2="50%" y2="82%" stroke="#C9A24B" stroke-width="1.2" opacity=".5"/>
      <line x1="22%" y1="48%" x2="17%" y2="48%" stroke="#C9A24B" stroke-width="1.2" opacity=".5"/>
    `,
  },
  {
    id: "decor",
    ...
    svgPattern: `
      <defs>
        <pattern id="ap-{id}" width="70" height="70" patternUnits="userSpaceOnUse">
          <path d="M35 0L70 35L35 70L0 35Z" fill="none" stroke="#C9A24B" stroke-width=".4" opacity=".2"/>
          <circle cx="35" cy="35" r="22" fill="none" stroke="#EBCB7C" stroke-width=".35" opacity=".2"/>
          <circle cx="35" cy="35" r="9" fill="none" stroke="#C9A24B" stroke-width=".35" opacity=".25"/>
        </pattern>
      </defs>
      <rect width="100%" height="100%" fill="url(#ap-{id})"/>
      <g transform="translate(50%,50%)">
        <polygon points="0,-38 11,-11 38,0 11,11 0,38 -11,11 -38,0 -11,-11" fill="none" stroke="#EBCB7C" stroke-width="1.2" opacity=".5"/>
        <polygon points="0,-25 7,-7 25,0 7,7 0,25 -7,7 -25,0 -7,-7" fill="none" stroke="#C9A24B" stroke-width=".8" opacity=".4"/>
        <circle r="10" fill="#080d12" stroke="#C9A24B" stroke-width="1.2" opacity=".9"/>
        <circle r="4" fill="#C9A24B" opacity=".75"/>
      </g>
    `,
  },
  {
    ...
    bgClass: "from-[#F4EFE6] via-[#1c1808] to-[#0d0b06]",
    badgeCode: "SIGNS",
    gridClass: "md:col-span-1 md:row-span-1",
    svgPattern: `
      <defs>
        <pattern id="sp-{id}" width="20" height="20" patternUnits="userSpaceOnUse">
          <circle cx="10" cy="10" r="1.5" fill="#C9A24B" opacity=".12"/>
        </pattern>
      </defs>
      <rect width="100%" height="100%" fill="url(#sp-{id})"/>
      <rect x="12%" y="20%" width="76%" height="55%" rx="6" fill="none" stroke="#C9A24B" stroke-width="1.2" stroke-dasharray="7 3" opacity=".4"/>
      <rect x="18%" y="26%" width="64%" height="43%" rx="4" fill="rgba(201,162,75,.04)" stroke="#EBCB7C" stroke-width=".7" opacity=".3"/>
      <text x="50%" y="52%" text-anchor="middle" dominant-baseline="middle" font-family="JetBrains Mono" font-size="9%" font-weight="700" fill="#C9A24B" opacity=".55">SIGN</text>
      <line x1="22%" y1="78%" x2="78%" y2="78%" stroke="#C9A24B" stroke-width=".5" opacity=".25"/>
      <circle cx="50%" cy="84%" r="3%" fill="none" stroke="#C9A24B" stroke-width=".8" opacity=".3"/>
      <line x1="50%" y1="87%" x2="50%" y2="94%" stroke="#C9A24B" stroke-width=".8" opacity=".3"/>
    `,
  },
  {
    id: "ads",
    ...
    svgPattern: `
      <defs>
        <pattern id="adp-{id}" width="18" height="18" patternUnits="userSpaceOnUse">
          <circle cx="9" cy="9" r="1.4" fill="#C9A24B" opacity=".12"/>
        </pattern>
      </defs>
      <rect width="100%" height="100%" fill="url(#adp-{id})"/>
      <path d="M10%,60% Q25%,25% 50%,40% Q75%,55% 90%,20%" fill="none" stroke="#EBCB7C" stroke-width="1.3" opacity=".4" stroke-dasharray="5 3"/>
      <circle cx="50%" cy="40%" r="3%" fill="#C9A24B" opacity=".5"/>
      <circle cx="25%" cy="42%" r="2%" fill="#EBCB7C" opacity=".35"/>
      <circle cx="75%" cy="38%" r="2%" fill="#EBCB7C" opacity=".35"/>
      <line x1="25%" y1="42%" x2="50%" y2="40%" stroke="#C9A24B" stroke-width=".6" opacity=".3" stroke-dasharray="3 2"/>
      <line x1="75%" y1="38%" x2="50%" y2="40%" stroke="#C9A24B" stroke-width=".6" opacity=".3" stroke-dasharray="3 2"/>
    `,
  },
  {
    id: "design",
    ...
    svgPattern: `
      ...
      <line x1="33%" y1="0" x2="33%" y2="100%" stroke="#C9A24B" stroke-width=".4" opacity=".18"/>
      <line x1="66%" y1="0" x2="66%" y2="100%" stroke="#C9A24B" stroke-width=".4" opacity=".18"/>
      <line x1="0" y1="50%" x2="100%" y2="50%" stroke="#C9A24B" stroke-width=".4" opacity=".18"/>
      <path d="M5%,75% C20%,15% 35%,80% 50%,45% S75%,15% 95%,65%" fill="none" stroke="#EBCB7C" stroke-width="1.4" opacity=".45" stroke-dasharray="5 3"/>
      <circle cx="50%" cy="45%" r="2.5%" fill="#C9A24B" opacity=".5"/>
      <circle cx="20%" cy="48%" r="1.5%" fill="none" stroke="#C9A24B" stroke-width="1" opacity=".4"/>
      <circle cx="80%" cy="42%" r="1.5%" fill="none" stroke="#C9A24B" stroke-width="1" opacity=".4"/>
      <rect x="76%" y="15%" width="7%" height="7%" rx="2" fill="#C9A24B" opacity=".5"/>
      <rect x="85%" y="15%" width="7%" height="7%" rx="2" fill="#EBCB7C" opacity=".4"/>
      <rect x="80.5%" y="24%" width="7%" height="7%" rx="2" fill="#9A6A2A" opacity=".4"/>
    `,
  },
];
